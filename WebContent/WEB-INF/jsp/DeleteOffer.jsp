...
<body>
	...
	<!-- ==================================Usun oferte o danym ID================================================== -->	
	<h1>Usun oferte o danym id</h1>	
		
		<div class="form">
		
			<div class="one">
				<div class="leftleft">
					<form title="usunOferte" method="POST" action="deleteOffer" >
						...
						<table border="0" align="center" cellpadding="4">
							...
							<tr>
								<td colspan="2"><input type="submit" value="Usuń Ofertę" class="formButton"/> &nbsp;</td>
							</tr>
						</table>
					</form>
				...
				<div id="left">
					<form action="share" method="post">
							...
							<input type="hidden" name="path" value="DeleteOffer">

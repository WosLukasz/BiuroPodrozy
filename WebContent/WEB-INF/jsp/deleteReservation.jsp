...
<!-- ==================================Usun rezerwacje o danym ID================================================== -->	
	<h1>Usun rezerwacje</h1>
<!-- 
	<form title="usunRezerwacje" method="POST" action="deleteReservation" >

		<table border="0" align="center" cellpadding="4">
			<tr>
				<td>Id rezerwacji:</td>
				<td><input type="text" name="idRez" /><font
					color="red">*</font></td>
			</tr>
			<tr>
				<td>Id oferty:</td>
				<td><input type="text" name="idOf" /><font
					color="red">*</font></td>
			</tr>
			<tr>
				<td colspan="2"><input type="submit" value="Usuń Rezerwację" class="formButton"/> &nbsp;</td>
			</tr>
		</table>
	</form>
-->
			...
			<tr>
				...
				<td>
					<form title="usunRezerwacje" method="POST" action="deleteReservation" >
							...
							<input type="hidden" name="idRez" value="${entry.value.idRez}" />
							<input type="hidden" name="idOf" value="${entry.value.idOferty}" />
							<input type="submit" value="Usuń Rezerwację" style="color: red;" />
					</form>

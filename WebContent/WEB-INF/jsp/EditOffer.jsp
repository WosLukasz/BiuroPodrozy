...
<body>
	...
	<!-- ==================================Dodaj nową ofertę================================================== -->
		...
		<h1>Edytuj oferte o danym ID</h1>
		...
		<div class="form">
			...
			<!-- 
				<div class="leftleft">
					...
					<p><strong>Wypelnij tylko te pola ktore chcesz zmienic. Musisz podać id oferty</strong></p>
					<br/>
				
					<form title="edytujOferte" method="POST" action="editOffer" >

							<table border="0" align="center" cellpadding="4">
								<tr>
									<td>Id oferty którą chcesz zmodyfikować:</td>
									<td><input type="text" name="idOferty" /><font
										color="red">*</font></td>
								</tr>
								<tr>
									<td>Nazwa Hotelu</td>
									<td><input type="text" name="nazwaHotelu" /></td>
								</tr>
								<tr>
									<td>cena</td>
								...
								<tr>
									<td>lokalizacja</td>
									<td><input type="text" name="lokalizacja" /></td>
								</tr>
								<tr>
									<td>Wyzywienie</td>
									<td>
								...
								<tr>
									...
									<td><input type="text" name="dataWyjazdu" /></td>
								</tr>
								<tr>
									<td>data powrotu (YYYY-MM-DD)</td>
									<td><input type="text" name="dataPowrotu" /></td>
								</tr>
								<tr>
									<td>Ilosc Miejsc</td>
									<td><input type="text" name="iloscMiejsc" /></td>
								</tr>
								<tr>
									<td>Opis wycieczki</td>
									<td>
										<textarea name="opisWycieczki"  rows="5" cols="40 "></textarea>	
									</td>
								</tr>
								
								<tr>
									<td colspan="2"><input type="submit" value="Edytuj" class="formButton"/> &nbsp;</td>
								</tr>
							</table>
						</form>
			...
			-->
				<div id="left">
					...
					<form action="share" method="post">
							...
							<input type="hidden" name="path" value="EditOffer">
			...
			<div id="right">
				...
				<c:forEach items="${list}" var="o">
					...
					<div class="of">
						...
						<div style ="font-weight:bold; padding: 15px;">Id oferty: ${o.idOferty}<br/></div>
					
					<form title="edytujOferte" method="POST" action="editOffer" >

						<input type="hidden" name="idOferty" value="${o.idOferty}" />
						
							<table border="0" align="center" cellpadding="4">
								
								<tr>
									<td>Nazwa Hotelu</td>
									<td><input type="text" name="nazwaHotelu" value="${o.nazwaHotelu}"/></td>
								</tr>
								<tr>
									<td>cena</td>
									<td><input type="text" name="cena" value="${o.cena}" /></td>
								</tr>
								<tr>
									<td>lokalizacja</td>
									<td><input type="text" name="lokalizacja" value="${o.lokalizacja}" /></td>
								</tr>
								<tr>
									<td>Wyzywienie</td>
									<td>
									<select name="wyzywienie" >
										<option value="${o.wyzywienie}" >Nie zmieniaj</option>
										<option value="UltraAllinclusive" >Ultra Allinclusive</option>
										<option value="Allinclusive" >Allinclusive</option>
										<option value="HB+" >HB+</option>
										<option value="HB" >HB</option>
									...
									<!-- <td><input type="text" name="wyzywienie" /></td> -->
									
								</tr>
								<tr>
									<td>data wyjazdu (YYYY-MM-DD)</td>
									<td><input type="text" name="dataWyjazdu" value="${o.dataWyjazdu}"/></td>
								</tr>
								<tr>
									<td>data powrotu (YYYY-MM-DD)</td>
									<td><input type="text" name="dataPowrotu" value="${o.dataPowrotu}"/></td>
								</tr>
								<tr>
									<td>Ilosc Miejsc</td>
									<td><input type="text" name="iloscMiejsc" value="${o.iloscMiejsc}"/></td>
								</tr>
								<tr>
									<td>Opis wycieczki</td>
									<td>
										<textarea name="opisWycieczki"  rows="5" cols="40 ">${o.opisWycieczki}</textarea>	
									</td>
								</tr>
